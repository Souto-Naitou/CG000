...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int)
{
	...
	/// TODO: 場所が違う場合変更[PSO] 4/24
	/// RootSignature作成
	D3D12_ROOT_SIGNATURE_DESC dexcriptionRootSignature{};
	dexcriptionRootSignature.Flags =
		D3D12_ROOT_SIGNATURE_FLAG_ALLOW_INPUT_ASSEMBLER_INPUT_LAYOUT;
	// シリアライズしてバイナリにする
	ID3DBlob* signatureBlob = nullptr;
	ID3DBlob* errorBlob = nullptr;
	hr = D3D12SerializeRootSignature(&dexcriptionRootSignature,
